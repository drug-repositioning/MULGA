...
def parse_args():
    ...
    parser.add_argument('-epoch_num', '--epoch_topofallfeature', type=int, nargs='?', default=200,help='number of epoch.')
...
if __name__=="__main__":
    ...
    data_folder = "/home/jiani.ma/dbMVGCNAE/ablation/multi_view_ablation/drug_view/drug_ablation_affinity_mat/"
    drug_sim_path = "mogan_ablation_affinity_mat.xlsx"
