...
if __name__=="__main__":
    ...
    root_path = "/home/jiani.ma/dbMVGCNAE/dataset/drug_feature"
    macc_path = os.path.join(root_path,"MACC_feature.xlsx") 
    mogan_path = os.path.join(root_path,"mogan_feature.xlsx")
    #rdk_path = os.path.join(root_path,"RDK_feature.xlsx")
    
    # Drug Features or Target features
    macc = pd.read_excel(macc_path,header=None).values   # 708 * 100
    mogan = pd.read_excel(mogan_path,header=None).values   # 708 * 5603
    #rdk = pd.read_excel(rdk_path,header=None).values  # 708 * 4192
