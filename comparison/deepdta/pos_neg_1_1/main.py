...
def parse_args():
    ...
    parser.add_argument('-num_filters', '--num_filters_topofallfeature', type=int, nargs='?', default=6,help='number of epoch.')
...
if __name__=="__main__":
    ...
    embedding_size = args.embedding_size_topofallfeature
    ...
    for fold_int in range(10):
        ...
        test_scores_arr = test_scores.detach().cpu().numpy()
