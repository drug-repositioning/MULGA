...
def parse_args():
    ...
    parser.add_argument('-num_filters', '--num_filters_topofallfeature', type=int, nargs='?', default=6,help='defining the size of hidden layer of GCN.')
    parser.add_argument('-epoch_num', '--epoch_num_topofallfeature', type=int, nargs='?', default=100,help='ratio of drop the graph nodes.')
    parser.add_argument('-lr', '--lr_topofallfeature', type=float, nargs='?', default=0.00005,help='number of epoch.')
...
if __name__=="__main__":
    ...
    topk = 1
    n_splits = 10    
    data_folder = "/home/jiani.ma/dbMVGCNAE/comparision/graphdta/data"
    drug_sim_path = "./drug_affinity_matrix.xlsx"
    target_sim_path = "./protein_affinity_matrix"   
    DTI_path = "./dti_mat.xlsx"
    drug_smiles_path = './drug.xlsx'
    target_fasta_path = './target.xlsx'
