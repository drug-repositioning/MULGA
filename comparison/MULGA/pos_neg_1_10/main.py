...
def parse_args():
    ...
    parser.add_argument('-hgcn_dim', '--hgcn_dim_topofallfeature', type=int, nargs='?', default=1800,help='defining the size of hidden layer of GCN.')
    parser.add_argument('-dropout', '--dropout_topofallfeature', type=float, nargs='?', default=0.3,help='ratio of drop the graph nodes.')
    parser.add_argument('-epoch_num', '--epoch_topofallfeature', type=int, nargs='?', default=1000,help='number of epoch.')
...
if __name__=="__main__":
    ...
    lr = 0.000008     
    topk = 10      #control the number of negative sample 
